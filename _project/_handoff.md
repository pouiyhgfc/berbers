...
**Antwoord-normalisatie** (`normalizeAnswer`) doet NFC + lowercase + trim + collapse whitespace + strip eind-leesteken, zodat `"Necc ḏ Mimun."` matcht met `"necc ḏ mimun"`.
...
{ "type": "translate",
  ...
  "correct": "necc ḏ Mimun",
  "accept": ["necc ḏ Mimun", "necc ḏ mimun"],
  "placeholder": "necc ḏ …" }

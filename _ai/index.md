<!-- AUTO-GEGENEREERD uit sjabloon + berekende cijfers (CSV, _ai/cursus.md, _ai/grammatica.md, _ai/zinnen.md)
...
|---|---|---|
| `woordenlijst.md` | lexicon, 1785 woorden | woorden en stammen |
| `grammatica.md` | 20 hoofdstukken regels + paradigma's | regels en afleidingen; verwijs met § + nummer (bv. §4.1) |
| `cursus.md` | 38 lessen uitleg | lesvolgorde en didactische uitleg |
| `zinnen.md` | 1208 geattesteerde zinnen | geattesteerde voorbeeldzinnen |
...
- 38 lessen → [cursus.md](cursus.md)
- 20 grammaticahoofdstukken → [grammatica.md](grammatica.md)
- 1208 geattesteerde zinnen → [zinnen.md](zinnen.md)

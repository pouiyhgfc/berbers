...
Tarifit heeft maar drie "echte" klinkers — a, i en u — plus de korte e. Elke klinker heeft twee uitspraken: een gewone, en een "donkere" variant naast emfatische medeklinkers (ḍ, ṣ, ṭ, ẓ, ṛ).

| Letter | Gewoon | Donker (emfatisch) | Voorbeeld |
| --- | --- | --- | --- |
| a | als "e" in het | als "a" in kat | wa "deze" |
| i | als "i" in ik | nauwelijks verschil | ini "zeggen" |
| u | tussen "o" en "oe" (bestaat niet in het Nederlands) | als "o" in op | ru "huilen" |
...
Streepje onder ( ḇ, ḏ, ṯ, ḵ ) — blazend/spirant: ḏ = "th" in Engels this · ṯ = "th" in Engels think · ḇ = zachte Spaanse b .

Puntje onder ( ḍ, ṣ, ṭ, ẓ, ṛ ) — donkere medeklinkers: Dieper uitgesproken, achterin de mond. De donkerte verspreidt zich over het hele woord — alle klinkers in dat woord klinken doffer mee.
...
## Les 02 — Persoonlijke voornaamwoorden

*les 02 · niveau 1*

"Ik, jij, hij, zij..." — de eerste woorden die je nodig hebt om iets over jezelf en anderen te zeggen.

**Links:** Uitleg → Hoofdstuk 5: Voornaamwoorden (uitleg.html#h6) · In het boek → Pagina 65 (boek.html)
...
| jullie (alleen vrouwen) | kennint |
| zij (mannen of gemengd) | niṯni ~ nihni |
| zij (alleen vrouwen) | niṯenti ~ nihenti |

> **Belangrijk verschil met Nederlands:** Tarifit maakt onderscheid tussen "jij (M)" en "jij (V)" — in Nederlands hebben we maar één "jij". Tegen een man zeg je cekk , tegen een vrouw cemm . Hetzelfde geldt voor "jullie" en "zij".
...
necc ḏ Mimun — "ik ben Mimoun" ḏ necc — "ik ben het" (lett. "het is ik")

---

## Les 03 — "Ik ben..." — zinnen zonder werkwoord
...
| --- | --- | --- |
| necc ḏ Mimun | "ik · ḏ · Mimoun" | Ik ben Mimoun |
| netta ḏ āryaz | "hij · ḏ · man" | Hij is een man |
| nettaṯ ḏ ṯamɣārṯ | "zij · ḏ · vrouw" | Zij is een vrouw |
| ḏ necc | "d · ik" | Ik ben het |

#### "Hij is mijn broer"

Combineer met familiewoorden (Les 04):

- netta ḏ uma — "hij is mijn broer"
- ḏ uma — "het is mijn broer"

#### Wanneer gebruik je ḏ NIET?
...
**Links:** Uitleg → Hoofdstuk 3: Naamwoorden, sectie 3.6 (uitleg.html#h4) · In het boek → Pagina 48–49 (boek.html)
...
> **Let op:** baba betekent mijn vader, niet "vader" in algemene zin. Voor "een vader" heb je een andere constructie nodig die later komt.

---

## Les 05 — Begroetingen & dagelijkse uitdrukkingen

*les 05 · niveau 1*

Praktische zinnen die je meteen kunt gebruiken — gebouwd uit alles wat je tot nu toe hebt geleerd.

**Links:** Uitleg → Hoofdstuk 8: Pseudo-werkwoorden (uitleg.html#h9) · In het boek → Pagina 84, 147+ (boek.html)
...
| Tarifit | Vertaling |
| --- | --- |
| ḏ wenni netta | zo is het, oké (een vaste uitdrukking) |
| waxxa | oké, akkoord |
| ḏ necc | ik ben het |
| ḏ cekk? | ben jij het? (M) |
...
- aɣ-am — alsjeblieft (V) (tegen vrouw)
- aɣ-am-ṯ — hier heb je het (V)
...
**Links:** Uitleg → Hoofdstuk 4: Werkwoorden (uitleg.html#h5) · In het boek → Pagina 51–53 (boek.html)
...
Tarifit-werkwoorden krijgen vervoegingsuitgangen aan beide kanten — vóór en na de stam. Nederlands heeft alleen achtervoegsels ("ik loop, jij loopt"), Tarifit heeft beide (" n e qqim " = "wij zitten").
...
> **Onthoud:** In woordenlijsten en op deze site staat een werkwoord in de gebiedende wijs — de korte vorm zoals je iemand een opdracht geeft. Van daaruit bouw je alle andere personen met voor- en achtervoegsels.

---

## Les 07 — Vervoeging: ik / jij / hij / zij
...
**Links:** Uitleg → Hoofdstuk 4: Werkwoorden (uitleg.html#h5) · In het boek → Pagina 51 (boek.html)
...
> **Belangrijke regel:** De vrouwelijke meervoudsvormen ( -enṯ ) gebruik je alleen als de groep volledig uit vrouwen bestaat. Eén man in de groep? Dan wordt het automatisch de mannelijke vorm — net als in Frans of Spaans.
...
## Les 09 — Aspect: afgerond vs lopend

*les 09 · niveau 2*

Het grootste verschil tussen Tarifit en Nederlands. Eenmaal begrepen, klopt alles ineens.

**Links:** Uitleg → Hoofdstuk 4 + 13 (uitleg.html#h5) · In het boek → Pagina 58–63, 113–117 (boek.html)
...
| --- | --- |
| "Ik eet (gewoonte)" | teteɣ (Imperfectief) |
| "Ik ben aan het eten" | qa teteɣ (qa + Imperfectief) |
| "Ik heb gegeten / ik at" | cciɣ (Perfectief) |
...
> **Eerlijk gezegd...:** De Imperfectief is het meest onregelmatige onderdeel van Tarifit. Er zijn patronen, maar geen regel die altijd klopt. De beste aanpak: leer per werkwoord de drie vormen samen — net zoals je in Engels "go / went / gone" als drieling leert.
...
2. Als onderwerp aan het begin: āryaz-a d ayyaw-nnes "deze man is zijn kleinzoon"
...
| waa... ura d | zelfs niet | waa ɣari ura d ijjen "ik heb helemaal niemand" |
...
- tuɣa-c d ameddukeř inu — "jij was mijn vriend"
...
- aɣyur d ameqqṛan — "een grote ezel"
...
- āryaz nneɣni d ṯamɣaṯ nneɣni — "een andere man en een andere vrouw"
...
- aɣ-am — "alsjeblieft (V), hier!"
- aɣ-am-ṯ — "hier heb je het (V)"
- aɣ-as adlis — "hier heeft hij/zij een boek"
...
- qa yenna-ac uǧeǧid — "de koning heeft tegen jou gezegd..."
- qa igemmaa ayarraf s waman — "hij heeft (zojuist) de kruik met water gevuld"

> **Beperking:** qa kan niet in bijzinnen of na vraagwoorden. Ook niet ontkend worden.
...
**Links:** Uitleg → Hoofdstuk 15: Betrekkelijke bijzinnen (uitleg.html#h16) · In het boek → Pagina 135–138 (boek.html)
...
- qa yewt-ayi ijjen sseyyed [ucaay-as aysum] "een man waar ik vlees van had gestolen heeft mij geslagen" [bijzin tussen haken]
...
| Tarifit | Letterlijk | Vertaling |
| --- | --- | --- |
| āryaz-enni [d ɣa yasen] | "man-die [hither / ad / komend]" | "de man die gaat komen" |
| wenni [ixeddmen řebda] | "de-die [werkend altijd]" | "hij die altijd werkt" |
| āryaz [d-yusin] | "man [hither-komend]" | "de man die hier kwam" |

#### Met de relatief-marker i

Voor lijdend voorwerp en voorzetselgroepen gebruik je i als verbindingswoord:

- āryaz [i d-iwyeɣ] — "de man die ik hierheen bracht" (lijdend voorwerp)
- missa [i x ssaaseɣ řkas-nni] — "de tafel waar ik dat glas op heb gezet" (voorzetsel)

#### Voor "aan wie" — umi

- āryaz [umi ṯ-wciɣ] — "de man aan wie ik het gaf"
...
**Links:** Uitleg → Hoofdstuk 15.3 (uitleg.html#h16) · In het boek → Pagina 137 (boek.html)
...
- (d) netta i d-yusin nhar-a "het is hij die vandaag gekomen is"
- d baba i d-yiwden "het is mijn vader die is aangekomen"

#### Lijdend-voorwerp-cleft

- (d) Mimun i ẓṛiɣ "het is Mimoun die ik zag"
- d nečč i waa ṯ-yezrin "het ben ik die hem niet zag"
...
| --- | --- |
| d netta i d-yusin "hij is het die kwam" | wi d-yusin? "wie is gekomen?" |
| d Mimun i ẓṛiɣ "Mimoun is wie ik zag" | min d-yesya? "wat heeft hij gekocht?" |
...
**Links:** Uitleg → Hoofdstuk 18: Voorbeeldteksten (uitleg.html#h19) · In het boek → Pagina 147–148 (boek.html)
...
Deze tekst komt uit Tudunin war itizyen ("Wonden die niet helen") van Eali Amaziɣ — een Marokkaans-Nederlandse schrijver die zijn jeugd in het Rifgebied beschrijft.

#### De tekst — over hoe sprookjes werden verteld

> **Tip:** Am necc am wattas n yewdan mamec i ɛeqřey "Zoals ik, zoals veel mensen, hoe ik mij herinner..."
...
ṯuɣa xminni i ɣa raḥey ad ttseɣ degg" xxam jaa yayeṯma d yemma...
...
Antwoord van de jongen: A ḥenna, necc ɛad waa ttiseɣ ca
...
**Links:** Uitleg → Hoofdstuk 18: Voorbeeldteksten (uitleg.html#h19) · In het boek → Pagina 149+ (boek.html)
...
- Voornaamwoorden aan werkwoorden geplakt: ḏas-ggeɣ "ik maak voor hem"
